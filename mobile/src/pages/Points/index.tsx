    ...
    return (
     <>  
        ...
        <View  style={styles.itemsContainer}>
          ...
          {items.map(item => (
            <TouchableOpacity style={styles.item} onPress={() => {}} key={String(item.id)}>
              <SvgUri width={56} height={56} uri={item.image_url} />
              <Text style={styles.itemTitle}>{item.title}</Text>
            </TouchableOpacity> 
          ))}
            {/* <TouchableOpacity style={styles.item} onPress={() => {}}>
                <SvgUri width={42} height={42} uri="http://192.168.27.107:33333/uploads/lampadas.svg" />
